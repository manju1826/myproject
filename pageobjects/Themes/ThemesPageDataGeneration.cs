...
{
    class ThemesPageDataGeneration : BasePage
    {
        ...
        public ISeleniumButtonService DM4KPageButton = Factory.ElementServices.GetWebButton(ElementSearchTypeConstants.CONST_SEARCH_BY_XPATH, "//img[@src='Admin/Assets/PageLayout/4KDM Dashboard.png']");
        public ISeleniumButtonService V32PageButton = Factory.ElementServices.GetWebButton(ElementSearchTypeConstants.CONST_SEARCH_BY_XPATH, "//img[@src='Admin/Assets/PageLayout/V32 Dashboard.png']");
        ...
        public ThemesPageDataGeneration(TestInputCache testInputCache) : base(testInputCache)
        {
        ...
        public void CreateNewThemeDM(String ThemeName)
            {
            Delay(10);
        ...
        public void CreateNewThemeLVDS(String ThemeName)
        {
            Delay(10);
            _driver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(20);
            PublishedButton.Click(_driver);
        ...
        public void CreateNewTheme4K(String ThemeName)
        {
        ...
        public void CreateNewThemeV32(String ThemeName)
        {
        ...
        public void CopyTheme(String ThemeName,String ThemeNewName)
        {
            ScrollToElement(_driver.FindElement(By.XPath("//span[@class='themename_box_cont  ng-binding' and contains(text(),'" + ThemeName + "')]")));
            CopyThemeButton(ThemeName).Click(_driver);
            Delay(1);
            ThemeNameTextBox.EnterText(_driver, ThemeNewName);
            CreateThemeButton.Click(_driver);
            WaitForPageLoad();
            WaitForSave();
            Delay(1);
        ...
        public bool uploadTheme(String ThemeName)
        {
            ...
            ChooseButtonButton.EnterText(_driver, @"C:\Users\kamreshbabu\Downloads\UploadDefault.zip");
            Delay(1);
