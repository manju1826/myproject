...
{
    class ThemeViewPageDataGeneration : BasePage
    {
        ...
        public ISeleniumButtonService LVDSPagePropertyButton = Factory.ElementServices.GetWebButton(ElementSearchTypeConstants.CONST_SEARCH_BY_XPATH, "//img[@src='Admin/Assets/PageLayout/LVDS Property.png']");
        public ISeleniumButtonService DMPropertyPageButton = Factory.ElementServices.GetWebButton(ElementSearchTypeConstants.CONST_SEARCH_BY_XPATH, "//img[@src='Admin/Assets/PageLayout/DM Left Section.png']");
        ...
        public ISeleniumButtonService CloseButton = Factory.ElementServices.GetWebButton(ElementSearchTypeConstants.CONST_SEARCH_BY_XPATH, "//button[@class='md-raised md-primary md-button md-ink-ripple redbg md-button']/span[contains(text(),' Cancel')]");


        #endregion

        public ThemeViewPageDataGeneration(TestInputCache testInputCache) : base(testInputCache)
        {
        ...
        public void Close(String Theme)
        {
            Delay(5);
            CloseButton.Click(_driver);
            Delay(1);
            WaitForPageLoad();


        }
        public void SubmitForApproval(String Theme)
        {
            Delay(5);
        ...
        public void AddNewDMFolderPage()
        {
        ...
        public void AddNewLVDSFolderPage()
        {

            WaitForPageLoad();
            AddNewPagebutton.Click(_driver);
            Delay(1 / 100);
            PageNameTextBox.EnterText(_driver, GetTestDataByFieldName("FolderNameLVDS"));
            Delay(1 / 100);
            NewPageType.Click(_driver);
            //select folder page
            new WebDriverWait(_driver, TimeSpan.FromSeconds(5)).Until(ExpectedConditions.ElementToBeClickable(By.XPath("//md-option/div[contains(text(),'Folder Page')]"))).Click();
        ...
        public void AddLVDSNewPropertyPage(string PropertyPageName)
        {
            ...
            LVDSPagePropertyButton.Click(_driver);
            Delay(1 / 100);
            CreatePageButton.Click(_driver);
            Delay(1);
            WaitForPageLoad();
        ...
        public void AddDMNewPropertyPage(string PropertyPageName)
        {
            ...
            //select Property page
            new WebDriverWait(_driver, TimeSpan.FromSeconds(5)).Until(ExpectedConditions.ElementToBeClickable(By.XPath("//md-option/div[contains(text(),'Property Page')]"))).Click();
            DMPropertyPageButton.Click(_driver);
            Delay(1 / 100);
            CreatePageButton.Click(_driver);
            Delay(1);
            WaitForPageLoad();
